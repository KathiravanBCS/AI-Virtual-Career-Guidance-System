  ...
  if (!quizQuestions || quizQuestions.length === 0) {
    return (
      <Container size="fluid" py="sm">
        <ListPageLayout title="No Quiz Found" titleProps={{ fw: 700, size: 'h2' }} description="No quiz questions found. Please generate some first.">
          <Stack gap="lg" align="center">
            <Button onClick={() => navigate('/quiz/generate')}>Generate Quiz</Button>
          </Stack>
        </ListPageLayout>
      </Container>
    );
