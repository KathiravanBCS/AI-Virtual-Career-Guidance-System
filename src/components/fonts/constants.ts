...
const SANS_SERIF_ENGLISH_FONT_FAMILIES = ['Roboto', 'Lato', 'Montserrat', 'OpenSans', 'Raleway'] as const;

const SERIF_ENGLISH_FONT_FAMILIES = ['Caladea', 'Lora', 'RobotoSlab', 'PlayfairDisplay', 'Merriweather'] as const;

export const ENGLISH_FONT_FAMILIES = [...SANS_SERIF_ENGLISH_FONT_FAMILIES, ...SERIF_ENGLISH_FONT_FAMILIES];
